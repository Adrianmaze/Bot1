...
if (command == 'music' || command == 'musica') {
...
await conn.sendMessage(m.chat, { document: { url: downloadUrl }, fileName: `${yt_play[0].title}.mp4`, caption: `┍━━━━━━┙❃┕━━━━━━┑\n┃ 𝙎𝙄𝙎𝙆𝙀𝘿 - 𝙂𝙊𝙊𝘿\n┃✧ ${yt_play[0].title}\n┕━━━━━━┑❃┍━━━━━━┙` }, { quoted: m });
} else {
await conn.sendMessage(m.chat, { video: { url: downloadUrl }, fileName: `${yt_play[0].title}.mp4`, caption: `┍━━━━━━┙❃┕━━━━━━┑\n┃ 𝙎𝙄𝙎𝙆𝙀𝘿 - 𝙂𝙊𝙊𝘿\n┃✧ ${yt_play[0].title}\n┕━━━━━━┑❃┍━━━━━━┙`, thumbnail: yt_play[0].thumbnail, mimetype: 'video/mp4' }, { quoted: m });
}} catch (e1) {
try {    
let qu = args[1] || '360'
let q = qu + 'p'
...
conn.sendMessage(m.chat, { video: { url: downloadUrl }, fileName: `${yt_play[0].title}.mp4`, caption: `┍━━━━━━┙❃┕━━━━━━┑\n┃ 𝙎𝙄𝙎𝙆𝙀𝘿 - 𝙂𝙊𝙊𝘿\n┃✧ ${yt_play[0].title}\n┕━━━━━━┑❃┍━━━━━━┙`, thumbnail: yt_play[0].thumbnail, mimetype: 'video/mp4' }, { quoted: m });
} catch (e6) {
try {
let d2 = await fetch(`https://exonity.tech/api/ytdlp2-faster?apikey=adminsepuh&url=${yt_play[0].url}`);
let dp = await d2.json();
...
if (fileSize > LimitVid) {
await conn.sendMessage(m.chat, { document: { url: audiop }, fileName: `${yt_play[0].title}.mp4`, caption: `┍━━━━━━┙❃┕━━━━━━┑\n┃ 𝙎𝙄𝙎𝙆𝙀𝘿 - 𝙂𝙊𝙊𝘿\n┃✧ ${yt_play[0].title}\n┕━━━━━━┑❃┍━━━━━━┙` }, { quoted: m });
} else {
await conn.sendMessage(m.chat, { video: { url: audiop }, fileName: `${yt_play[0].title}.mp4`, caption: `┍━━━━━━┙❃┕━━━━━━┑\n┃ 𝙎𝙄𝙎𝙆𝙀𝘿 - 𝙂𝙊𝙊𝘿\n┃✧ ${yt_play[0].title}\n┕━━━━━━┑❃┍━━━━━━┙`, thumbnail: yt_play[0].thumbnail, mimetype: 'video/mp4' }, { quoted: m });
}} catch (e) {    
await m.react('❌');
console.log(e);
}}}}}}}}
